...
namespace GravityEngine.Wrapper
{
    public partial class GravityEngineWrapper
    {
        ...
        private static IQueryDryRunCallback mQueryDryRunCallback;
        private static ISendDryRunCallback mSendDryRunCallback;
        ...
        public static string Track(string eventName, Dictionary<string, object> properties)
        {
            ...
            return track(eventName, getFinalEventProperties(properties));
        }

        public static string Track(string eventName, Dictionary<string, object> properties, DateTime datetime)
        {
            GE_PropertiesChecker.CheckString(eventName);
            return track(eventName, getFinalEventProperties(properties), datetime);
        }
        ...
        {
            GE_PropertiesChecker.CheckString(eventName);
            return track(eventName, getFinalEventProperties(properties), datetime, timeZone);
        }
        ...
        public static void InitializeIOS(bool enableAsa, string clientId, string caid1_md5, string caid2_md5, bool enableSyncAttribution, string channel, IInitializeCallback initializeCallback)
        {
            mInitializeCallback = initializeCallback;
            initializeIOS(enableAsa, clientId, caid1_md5, caid2_md5, enableSyncAttribution, channel, initializeCallback);
        }

        public static void QueryDryRunInfo(string traceId, Dictionary<string, object> otherParams, IQueryDryRunCallback queryDryRunCallback)
        {
            mQueryDryRunCallback = queryDryRunCallback;
            queryDryRunInfo(traceId, otherParams, queryDryRunCallback);
        }
        ...
        public static string TrackPayEvent(int payAmount, string payType, string orderId, string payReason,
            string payMethod)
        {
            return trackPayEvent(payAmount, payType, orderId, payReason, payMethod);
        }
        ...
        {
            filterAndReportPayEventToTencent(payAmount, traceId);
        }
    }
}