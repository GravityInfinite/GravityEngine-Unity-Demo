...
namespace GravityEngine.Wrapper
{
    public partial class GravityEngineWrapper
    {
        ...
        [DllImport("__Internal")]
        private static extern void ge_initialize_v3(string app_id, bool enableAsa, string client_id, string caid1_md5, string caid2_md5, bool enableSyncAttribution, string channel);
        ...
        private static void initializeIOS(bool enableAsa, string clientId, string caid1_md5, string caid2_md5, bool enableSyncAttribution, string channel, IInitializeCallback initializeCallback)
        {
            ...
            ge_initialize_v3(AppID, enableAsa, clientId, caid1_md5, caid2_md5, enableSyncAttribution, channel);
        }
        ...
        {
            GE_Log.d("not support queryDryRunInfo!");
        }
        
        private static void filterAndReportPayEventToTencent(int payAmount, string traceId)
        {
            GE_Log.d("not support filterAndReportPayEventToTencent!");
        }
