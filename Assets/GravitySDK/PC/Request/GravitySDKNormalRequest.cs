...
namespace GravitySDK.PC.Request
{
    public class GravitySDKNormalRequest : GravitySDKBaseRequest
    {
        ...
        public override IEnumerator SendData_2(ResponseHandle responseHandle, IList<Dictionary<string, object>> data)
        {
            ...
            CGMergeJsonResult commonResult = CGNetworkJsonMerger.MergeCommonFields(this.Data());

            param["common_properties"] = commonResult.CommonJson;
            param["event_list"] = commonResult.RecordArray;
            ...
            byte[] zipData = UnityWebRequestMgr.GzipData(contentCompressed);
            ...
            using (UnityWebRequest webRequest = new UnityWebRequest(uri, "POST"))
            {
                ...
                webRequest.SetRequestHeader("Gravity-Content-Compress", "gzip");
                webRequest.uploadHandler = (UploadHandler) new UploadHandlerRaw(zipData);
