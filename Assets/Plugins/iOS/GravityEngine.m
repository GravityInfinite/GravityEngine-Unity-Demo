...
void ge_initialize_v3(const char *app_id, bool enable_asa, const char *client_id, const char *caid1_md5, const char *caid2_md5, bool enableSyncAttribution, const char *channel) {
    NSString *app_id_string = app_id != NULL ? [NSString stringWithUTF8String:app_id] : nil;
    ...
    [ge_getInstance(app_id_string) initializeGravityEngineWithAsaEnable:enable_asa withClientId:client_id_string withCaid1:caid1_md5_string withCaid2:caid2_md5_string withSyncAttribution:enableSyncAttribution withChannel:channel_string withSuccessCallback:^(NSDictionary * _Nonnull response){
